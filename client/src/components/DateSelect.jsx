...
const DateSelect = ({dateTime,id}) => {
  ...
  return (
    <div id ='dateSelect' className='pt-30'>
        ...
        <button  onClick={onBookHandler} className='bg-primary text-while px-28 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer' >Book Now</button>
        </div>
    </div>
  )
}
